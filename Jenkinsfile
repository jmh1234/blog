...
def deployVersion(String version) {
    sh "ssh ubuntu@146.56.220.117 'sudo docker rm -f blog && sudo docker run --name=blog -d -p 8080:8080 -v /root/tmp/application.properties:/app/config/application.properties 146.56.220.117:5000/blog:${version}'"
}
